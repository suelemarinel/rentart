  ...
  return (
    <>
      ...
      <Link href={`/catalogue/${artwork.slug.current}`}>
        <div className="card bg-white rounded-xl border border-gray-200 overflow-hidden cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl">
